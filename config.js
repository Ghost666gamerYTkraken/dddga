...
config.client_uuid = "U6KHvGYGkk1KaLO"; // after you install the userscript press F12 and search for a debug msg on the console

// Location of your proxy files with HTTP proxies (Sock proxies not supported yet!)
config.proxies = "proxy.txt";
config.botsPerIp = 20;
config.onboardingTimer = 20;

// Maximum number of bots to load
config.maxBots = 2000;

config.useRandomSkinName = true; // Set to true to use random name
config.useStaticName = "KAKOBOTS"; // If above is false, us this skin name
